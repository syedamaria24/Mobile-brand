...
var mobiles = {
    ...
    xiomi: {
      ...
      realme: {
        realmiNote50: {
          ...
          battery: {
            capacity: "5000mAh",fastCharging: "65W",
          },
          operatingSystem: "Android 12",
          specialFeatures: [
        ...
        realmiC67: {
          ...
          battery: {
            ...
            operatingSystem: "Android 12",
            specialFeatures: ["In-display fingerprint sensor",
            "3.5mm headphone jack",
          ],
        }, realmi9: {
          brand: "Realme",
  ...
  function displayDetails() {
    ...
    if (brand && model && mobiles[brand] && mobiles[brand][model]) {
        var details = mobiles[brand][model];
        detailsDiv.innerHTML = `
            <h3>${brand.charAt(0).toUpperCase() + brand.slice(1)} - ${model.charAt(0).toUpperCase() + model.slice(1)}</h3>
            <p><strong>Processor:</strong> ${details.processor}</p>
            <p><strong>RAM:</strong> ${details.memory.ram} GB</p>
            <p><strong>Storage:</strong> ${details.memory.storage} GB</p>
            <p><strong>Battery:</strong> ${details.battery} mAh</p>
            <p><strong>Operating System:</strong> ${details.operatingSystem}</p>
            <p><strong>Special Features:</strong> ${details.specialFeatures.join(", ")}</p>
        `;
    } 
    else {
        detailsDiv.innerHTML = `<p>Please select a brand and model to view details.</p>`;
    }
  }
